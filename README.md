...
./daemon_process.sh -p "xray_linux_amd64" -c "./xray_linux_amd64 webscan --listen 0.0.0.0:7777 --html-output $RANDOM.html --burp-file $RANDOM.json --webhook-output http://127.0.0.1:5000/webhook "
